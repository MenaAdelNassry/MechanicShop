        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    EstimatedDurationInMins = table.Column<int>(type: "int", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkOrderTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairTaskParts", x => new { x.RepairTaskId, x.InventoryItemId });
                    table.ForeignKey(
                        name: "FK_RepairTaskParts_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RepairTaskParts_RepairTasks_RepairTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Spot = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    State = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ActualStartedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ActualCompletedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxRateAtIssuance = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WorkOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OriginalRepairTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LaborCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EstimatedDurationInMins = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkOrderTaskParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkOrderTaskParts_WorkOrderTasks_WorkOrderTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_TableName_PrimaryKey",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairTaskParts_InventoryItemId",
                table: "RepairTaskParts",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairTasks_CreatedAtUtc",
                table: "RepairTasks",
                column: "CreatedAtUtc")
                .Annotation("SqlServer:Clustered", true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_StartAtUtc_CreatedAtUtc",
                table: "WorkOrders",
                columns: new[] { "StartAtUtc", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderTaskParts_InventoryItemId",
                table: "WorkOrderTaskParts",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderTaskParts_WorkOrderTaskId",
                table: "WorkOrderTaskParts",
